  ...
  customer: [
    {
      ...
      items: [
        ...
        { label: 'Product Comparison', href: '/account/compare', icon: Scale },
      ],
    },
    {
      label: 'Purchases',
      items: [
        ...
        { label: 'My Quotations', href: '/account/quotations', icon: FileText },
        { label: 'Sourcing Requests', href: '/account/sourcing', icon: PackageSearch },
        { label: 'Shipments & Tracking', href: '/account/shipments', icon: Truck },
        { label: 'Payments', href: '/account/payments', icon: CreditCard },
        { label: 'Returns & Disputes', href: '/account/returns', icon: Package },
        { label: 'Documents & Invoices', href: '/account/documents', icon: ScrollText },
      ],
    },
    {
      label: 'Communication',
      items: [
        ...
        { label: 'Support Centre', href: '/account/support', icon: LifeBuoy },
      ],
    },
    {
      label: 'Account',
      items: [
        { label: 'Profile', href: '/account/profile', icon: UserCheck },
        { label: 'Addresses', href: '/account/addresses', icon: MapPin },
        { label: 'Payment Methods', href: '/account/payment-methods', icon: CreditCard },
        { label: 'Rewards & Referrals', href: '/account/referrals', icon: Gift },
