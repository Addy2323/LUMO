...
export async function POST(
  ...
  try {
    ...
    // Atomically increment impression counter and record interaction
    await prisma.$transaction([
      ...
      prisma.promotionInteraction.create({
        data: {
          ...
          event: PromotionInteractionEvent.IMPRESSION,
    ...
    console.error('[PROMOTION IMPRESSION TELEMETRY ERROR]', err)
