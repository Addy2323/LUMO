...
export async function POST(
  ...
  try {
    ...
    // Atomically increment dismissal counter and record interaction
    await prisma.$transaction([
      ...
      prisma.promotionInteraction.create({
        data: {
          ...
          event: PromotionInteractionEvent.DISMISS,
    ...
    console.error('[PROMOTION DISMISS TELEMETRY ERROR]', err)
